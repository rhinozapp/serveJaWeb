module.exports = function(app, http) {
    ...
    app.use(cors({origin: 'http://localhost:4200', methods: 'GET,HEAD,PUT,PATCH,POST,DELETE,OPTIONS'}));
    app.use(cors({origin: 'http://localhost', methods: 'GET,HEAD,PUT,PATCH,POST,DELETE,OPTIONS'}));
